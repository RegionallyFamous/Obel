...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--2-xl);padding-right:var(--wp--preset--spacing--lg);padding-bottom:var(--wp--preset--spacing--2-xl);padding-left:var(--wp--preset--spacing--lg)">
	...
	<h2 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Hands written by customers', 'foundry' ); ?></h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-columns alignwide" style="margin-top:var(--wp--preset--spacing--xl)">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group is-style-panel">
				...
				<blockquote class="wp-block-quote">
					<!-- wp:paragraph -->
					<p><?php esc_html_e( 'As described on the shop card. The house sees me again.', 'foundry' ); ?></p>
					<!-- /wp:paragraph -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group is-style-panel">
				...
				<blockquote class="wp-block-quote">
					<!-- wp:paragraph -->
					<p><?php esc_html_e( 'The parcel came promptly, and the wax seal was a small delight.', 'foundry' ); ?></p>
					<!-- /wp:paragraph -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group is-style-panel">
				...
				<blockquote class="wp-block-quote">
					<!-- wp:paragraph -->
					<p><?php esc_html_e( 'A year on the shelf and it reads as freshly sealed.', 'foundry' ); ?></p>
					<!-- /wp:paragraph -->
