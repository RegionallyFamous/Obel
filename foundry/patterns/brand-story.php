...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--2-xl);padding-right:var(--wp--preset--spacing--lg);padding-bottom:var(--wp--preset--spacing--2-xl);padding-left:var(--wp--preset--spacing--lg)">
	...
	<div class="wp-block-media-text alignwide is-stacked-on-mobile is-vertically-aligned-center">
		...
		<div class="wp-block-media-text__content">
			...
			<!-- wp:heading {"level":2} -->
			<h2 class="wp-block-heading"><?php esc_html_e( 'A short line about the house, as one might read on a shop card.', 'foundry' ); ?></h2>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"textColor":"secondary","fontSize":"md"} -->
			<p class="has-secondary-color has-text-color has-md-font-size"><?php esc_html_e( 'A short note from the bench explaining what the house compounds, the remedies it cares about, and who it keeps the ledger for &mdash; plainly said, in the maker&rsquo;s own hand.', 'foundry' ); ?></p>
			<!-- /wp:paragraph -->
