...
git clone https://github.com/RegionallyFamous/Selvedge.git selvedge
```

Then activate Selvedge in *Appearance > Themes*. If WooCommerce is installed, the storefront templates start rendering immediately.
...
Do not edit Selvedge directly for a real project. Clone it:

```bash
python3 bin/clone.py acme
```

Copies the theme to `../acme/`, renames every `Selvedge`/`selvedge` reference inside editable files, and prints next steps. Cross-platform (macOS, Linux, Windows). See `bin/clone.py --help` for options.

Then edit `theme.json` to set the brand. Templates do not need to change.

## Documentation

Long-form docs live in the [Selvedge Wiki](https://github.com/RegionallyFamous/Selvedge/wiki):

- [Getting Started](https://github.com/RegionallyFamous/Selvedge/wiki/Getting-Started) - install, clone, first edit
- [Architecture](https://github.com/RegionallyFamous/Selvedge/wiki/Architecture) - the philosophy, the five hard rules
- [Project Structure](https://github.com/RegionallyFamous/Selvedge/wiki/Project-Structure) - every file and what it does
- [Design Tokens](https://github.com/RegionallyFamous/Selvedge/wiki/Design-Tokens) - the vocabulary of the design system
- [Recipes](https://github.com/RegionallyFamous/Selvedge/wiki/Recipes) - 15 step-by-step common tasks
- [Block Reference](https://github.com/RegionallyFamous/Selvedge/wiki/Block-Reference) - every block grouped by purpose
- [Templates](https://github.com/RegionallyFamous/Selvedge/wiki/Templates) - what each template covers
- [WooCommerce Integration](https://github.com/RegionallyFamous/Selvedge/wiki/WooCommerce-Integration) - deep guide to every WC surface
- [Style Variations](https://github.com/RegionallyFamous/Selvedge/wiki/Style-Variations) - how to build whole-theme looks
- [Anti-Patterns](https://github.com/RegionallyFamous/Selvedge/wiki/Anti-Patterns) - 17 mistakes to avoid
- [Working with LLMs](https://github.com/RegionallyFamous/Selvedge/wiki/Working-with-LLMs) - using Claude, ChatGPT, Cursor, etc.
- [Tooling](https://github.com/RegionallyFamous/Selvedge/wiki/Tooling) - every script in `bin/` explained
- [Contributing](https://github.com/RegionallyFamous/Selvedge/wiki/Contributing) - how to send a PR
- [FAQ](https://github.com/RegionallyFamous/Selvedge/wiki/FAQ) - quick answers
...
These are not preferences. They define what Selvedge is.
...
If a request requires breaking one, the request needs to change, not the rule. See [Architecture](https://github.com/RegionallyFamous/Selvedge/wiki/Architecture) for the full reasoning.
...
The "INDEX.md in sync" check fails if you forget. See [Working with LLMs](https://github.com/RegionallyFamous/Selvedge/wiki/Working-with-LLMs) for more.
...
Each link below opens a disposable WordPress + WooCommerce install with Selvedge active and the [Wonders & Oddities](https://github.com/RegionallyFamous/wonders-oddities) dataset pre-loaded. Nothing to install locally. Expect 60 to 90 seconds on first boot while the dataset and images download.
...
| --- | --- | --- |
| Home | [`selvedge/`](https://demo.regionallyfamous.com/selvedge/) | [/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/selvedge/playground/blueprint.json&url=/) |
| Shop | [`selvedge/shop/`](https://demo.regionallyfamous.com/selvedge/shop/) | [/shop/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/selvedge/playground/blueprint.json&url=/shop/) |
| Single product | [`selvedge/product/bottled-morning/`](https://demo.regionallyfamous.com/selvedge/product/bottled-morning/) | [/product/bottled-morning/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/selvedge/playground/blueprint.json&url=/product/bottled-morning/) |
| Cart (pre-filled) | [`selvedge/cart/`](https://demo.regionallyfamous.com/selvedge/cart/) | [/cart/?demo=cart](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/selvedge/playground/blueprint.json&url=/cart/?demo=cart) |
| Checkout | [`selvedge/checkout/`](https://demo.regionallyfamous.com/selvedge/checkout/) | [/checkout/?demo=cart](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/selvedge/playground/blueprint.json&url=/checkout/?demo=cart) |
| My Account | [`selvedge/my-account/`](https://demo.regionallyfamous.com/selvedge/my-account/) | [/my-account/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/selvedge/playground/blueprint.json&url=/my-account/) |
| Journal | [`selvedge/journal/`](https://demo.regionallyfamous.com/selvedge/journal/) | [/journal/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/selvedge/playground/blueprint.json&url=/journal/) |
| 404 | [`selvedge/404/`](https://demo.regionallyfamous.com/selvedge/404/) | [/this-route-does-not-exist/](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/RegionallyFamous/fifty/main/selvedge/playground/blueprint.json&url=/this-route-does-not-exist/) |
