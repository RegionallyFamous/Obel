...
<footer class="wp-block-group alignfull has-subtle-background-color has-background" style="padding-top:var(--wp--preset--spacing--2-xl);padding-right:var(--wp--preset--spacing--lg);padding-bottom:var(--wp--preset--spacing--xl);padding-left:var(--wp--preset--spacing--lg)">
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column">
			...
			<h4 class="wp-block-heading has-sm-font-size" style="letter-spacing:var(--wp--custom--letter-spacing--wider);text-transform:uppercase"><?php esc_html_e( 'Shop', 'selvedge' ); ?></h4>
			<!-- /wp:heading -->
		...
		<div class="wp-block-column">
			<!-- wp:heading {"level":4,"fontSize":"sm","style":{"typography":{"letterSpacing":"var:custom|letter-spacing|wider","textTransform":"uppercase"}}} -->
			<h4 class="wp-block-heading has-sm-font-size" style="letter-spacing:var(--wp--custom--letter-spacing--wider);text-transform:uppercase"><?php esc_html_e( 'Support', 'selvedge' ); ?></h4>
			<!-- /wp:heading -->
			<!-- wp:paragraph -->
			<p><a href="#"><?php esc_html_e( 'Contact', 'selvedge' ); ?></a></p>
			<!-- /wp:paragraph -->
			<!-- wp:paragraph -->
			<p><a href="#"><?php esc_html_e( 'Shipping', 'selvedge' ); ?></a></p>
			<!-- /wp:paragraph -->
			<!-- wp:paragraph -->
			<p><a href="#"><?php esc_html_e( 'Returns', 'selvedge' ); ?></a></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column">
			<!-- wp:heading {"level":4,"fontSize":"sm","style":{"typography":{"letterSpacing":"var:custom|letter-spacing|wider","textTransform":"uppercase"}}} -->
			<h4 class="wp-block-heading has-sm-font-size" style="letter-spacing:var(--wp--custom--letter-spacing--wider);text-transform:uppercase"><?php esc_html_e( 'Legal', 'selvedge' ); ?></h4>
			<!-- /wp:heading -->
			<!-- wp:paragraph -->
			<p><a href="#"><?php esc_html_e( 'Privacy', 'selvedge' ); ?></a></p>
			<!-- /wp:paragraph -->
			<!-- wp:paragraph -->
			<p><a href="#"><?php esc_html_e( 'Terms', 'selvedge' ); ?></a></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
	</div>
