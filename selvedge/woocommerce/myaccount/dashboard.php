<?php
/**
 * My Account dashboard — Selvedge override.
 *
 ...
 * `selvedge_render_account_dashboard` callback registered in
 ...
 * relative path matches: `selvedge/woocommerce/myaccount/dashboard.php`.
 *
 * @package selvedge
 */
